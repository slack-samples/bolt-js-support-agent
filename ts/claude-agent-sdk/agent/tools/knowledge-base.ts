...
const KB_ARTICLES: Record<string, KBArticle> = {
  vpn: {
    ...
    if (matches.length === 0) {
      return {
        content: [
          {
            type: 'text' as const,
            text: 'No knowledge base articles found matching the query. Consider creating a support ticket for further assistance.',
          },
        ],
      };
    }
